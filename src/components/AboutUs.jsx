...
return (
    ...
    <div className="wrapper">
        <div className="container">
            ...
            <p className="text-justify">Tasty is an interactive website for food lovers and home cooks. It is a hub for finding recipes ranging from quick and easy to 
